...
class UserSocialInfoPublic {
  ...
  factory UserSocialInfoPublic.fromJson(Map<String, dynamic> json) {
    return UserSocialInfoPublic(
      ...
      mastodonHandle: json['mastodonHandle'] as String?,
      pixelfedHandle: json['pixelfedHandle'] as String?,
  ...
  List<SocialEntry> toList() {
    return [
      ...
      if (mastodonHandle != null) SocialEntry('Mastodon', mastodonHandle!, null),
      if (pixelfedHandle != null) SocialEntry('Pixelfed', pixelfedHandle!, null),

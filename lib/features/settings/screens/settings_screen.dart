                ...
                DesignCard.list(
                  children: [
                    DesignListTile(
                      ...
                      title: 'Zeitzone',
                      subtitle: AppScope.of(context).timeZones.effective,
                      trailing: const Icon(Icons.chevron_right_rounded),
                      onTap: () => context.push('/einstellungen/zeitzone'),
                    ),
                  ],
                ),
                const SizedBox(height: 8),
                ...
                DesignCard.list(
                  children: [
                    ...
                    DesignListTile(
                      ...
                      title: 'LaMetric Time',
                      subtitle: 'Ungelesene Benachrichtigungen auf der Uhr',
                      trailing: const Icon(Icons.chevron_right_rounded),
                      onTap: () => context.push('/einstellungen/lametric'),
                    ),
                  ],
                ),
